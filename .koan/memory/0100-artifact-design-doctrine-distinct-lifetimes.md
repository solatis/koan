...
**Update (living-documents change, 2026-06-22):** the lifetime taxonomy is collapsed. The 'disposable plan' class is superseded -- plans (plan.md / plan-milestone-N.md) are now LIVING documents: re-runnable, edited in place, and owning their inline ## Review and ## Execution N sections rather than being written-once-and-consumed-once. milestones.md remains additive-forward (Outcome sections append-only) and is additionally mutable for future scope (the orchestrator may adjust or inject not-yet-started milestones). brief.md remains frozen, the one write-once artifact; core-flows.md and tech-plan.md are stable-after-their-producing-phase by convention. The one-lifetime / reader-driven / work-backwards principles still hold; only the frozen/additive/disposable class names no longer describe plans.
