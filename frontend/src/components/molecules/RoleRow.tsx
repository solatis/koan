 ...
 *
 * A role is exactly connection + model + thinking. Layout follows dependency
 * order; the cascade disables each control until its dependency is set.
 * Presentational: auto-save, validation, and error toasts live in the parent.
 */
