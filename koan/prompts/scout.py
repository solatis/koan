...
SYSTEM_PROMPT = (
    ...
    "failure will pollute your investigation. You do not yield, you do\n"
    "not ask questions, you do not converse with the user. Your final\n"
    "text response IS your handoff.\n"
    "\n"
